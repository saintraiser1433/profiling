...
if (isset($_POST['submit'])) {
  ...
  $date = $_POST['dates'];
  $mess = $_POST['mess'];
  if ($mess == '<span class="text-danger">Not Available</span>') {
    $_SESSION['response'] = "This position is not available";
    $_SESSION['type'] = "danger";
  } else {
    $sql = "INSERT into official (firstname,middlename,lastname,position,date_elected) values (?,?,?,?,?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("sssss", $name, $mname, $lname, $position, $date);
    $stmt->execute();
...
if (isset($_POST['update'])) {
  ...
  $mnames = $_POST['middlenames'];
  $lnames = $_POST['lastnames'];
  $positonss = $_POST['positionssf'];
  $datess = $_POST['datesss'];
  $ids = $_POST['myidss'];
  $mess = $_POST['messs'];
  if ($mess == '<span class="text-danger">Not Available</span>') {
    $_SESSION['response'] = "This position is not available";
    ...
    $sql = "UPDATE official SET firstname=? ,middlename=?,lastname=?,position=?,date_elected=? where id=?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("sssssi", $fnames, $mnames, $lnames, $positonss, $datess, $ids);
    $stmt->execute();
  ...
  <div id="wrapper">
        ...
        <div class="col-lg-12">
          <div class="card mb-4">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
              ...
              <h6 class="m-0 font-weight-bold text-primary">LIST OF BARANGAY OFFICIALS</h6>
        ...
        <div class="modal-dialog modal-md">
          <div class="modal-content">
            <div class="modal-header bg-primary text-white">
              <h5 class="modal-title" id="staticBackdropLabel">Add Officials</h5>
            ...
            <div class="modal-body">
              ...
              <form action="" method="post">
                ...
                <div class="col">
                  ...
                  <span id="mess"></span>
                  <input type="text" name="mess" id="met" style="display: none;">
                </div>
                <br>
                <div class="col">
                  <label>Date Elected</label>
                  <input id="datepicker" class="form-control" name="dates" required>
                </div>
    ...
    <div class="modal fade" id="staticBackdrops" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog modal-md">
        <div class="modal-content">
          <div class="modal-header bg-primary text-white">
            <h5 class="modal-title" id="staticBackdropLabel">Edit Officials</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            ...
            <form action="" method="post">
              <input type="hidden" id="myidss" name="myidss">
              <div class="col">
                <label>First Name</label>
                <input type="text" class="form-control" name="firstnames" id="firstnames" placeholder="Enter First Name" required>
              </div>
              <br>
              <div class="col">
                <label>Middle Name</label>
                <input type="text" class="form-control" name="middlenames" id="middlenames" placeholder="Enter Middle Name" required>
              </div>
              <br>
              <div class="col">
                <label>Last Name</label>
                <input type="text" class="form-control" name="lastnames" id="lastnames" placeholder="Enter Last Name" required>
              </div>
              <br>

              <div class="col">
                <label>Position</label>
                <select name="positionssf" id="positions" class="form-control" required>
                  <option value="">-SELECT-</option>
                  <option value="Barangay Chairman">Barangay Chairman</option>
                  <option value="SK Chairman">SK Chairman</option>
                  <option value="Barangay Secretary">Barangay Secretary</option>
                ...
                <span id="messs"></span>
                <input type="text" name="messs" id="mets" style="display: none;">

              </div>
              <br>
              <div class="col">
                <label>Date Elected</label>
                <input id="datepickers" class="form-control" name="datesss" required>
              </div>
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      $('a.edit').on('click', function() {
        ...
        console.log(data);
        $('#myidss').val(data[1]);
        $('#firstnames').val(data[3]);
        $('#middlenames').val(data[4]);
        $('#lastnames').val(data[5]);
        $('#positions').val(data[6]);
        $('#datepickers').val(data[7]);
      });
