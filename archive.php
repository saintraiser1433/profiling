...
<?php  unset($_SESSION['response']); 
 ...
 <!-- Modal retrieve -->
    ...
    Loading...
                  ...
                  <center><p>Are you sure you want to retrieve this data?</p>
                    <h4><b>Resident ID:</b></h4><h4 id="dataa"></h4></center>
                </div>
                <div class="modal-footer">
                  <button type="button" class="btn btn-outline-primary" data-dismiss="modal">Cancel</button>
         ...
         <!-- Modal delete -->
          <div class="modal fade" id="deletedModals" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabelLogout"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header bg-primary text-white">
    ...
    Loading...
                  ...
                  <center><p>Are you sure you want to delete this data?</p>
                    <h4><b>Resident ID:</b></h4><h4 id="dataab"></h4></center>
                </div>
                <div class="modal-footer">
                  <button type="button" class="btn btn-outline-primary" data-dismiss="modal">Cancel</button>
